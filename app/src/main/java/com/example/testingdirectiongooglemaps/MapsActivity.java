package com.example.testingdirectiongooglemaps;
...
import com.example.testingdirectiongooglemaps.databinding.ActivityMapsBinding;
    ...
    public void Findroutes(LatLng Start, LatLng End)
    {
        ...
        else
        {
            ...
            Routing routing = new Routing.Builder()
                    ...
                    .waypoints(Start, End)
                    .key("AIzaSyDyT8Qqete7ZASxSESCruk10StWuo-miFk")  //also define your api key here.
                    .build();
            routing.execute();
        }
    }
